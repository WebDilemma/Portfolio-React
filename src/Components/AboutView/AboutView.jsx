          ...
          <div className="about__infoContainer">
            <div className="about__row">
              <div className="about__infoText">
                ...
                <p className="info__description">
                  ...
                  adapt to new technology but also new developers to contribute
                  to the world of tech using creative ideas! Because Everyone Is
                  Unique!
                </p>
              </div>
            ...
            <div className="about__row">
              ...
              <div className="about__infoText">
                ...
                <p className="info__description">
                  We're a team of 4 developers working at the core of Web
                  Dilemma, Though We’re not limited to a few developers. We help
                  new developers work on real projects and help them grind their
